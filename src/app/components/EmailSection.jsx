        ...
        <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
            ...
            <div className='z-10'>
                ...
                <div className='socials flex flex-row gap-2'>
                    <Link href="github.com" className='h-10 w-10'>
                        <Image src={github} alt="Git" style={{ filter: 'invert(100%)' }}/>
                    </Link>
                    <Link href="linkedin.com" className='h-10 w-10'>
                        <Image src={linkedin} alt="Linked In" style={{ filter: 'invert(100%)' }} />
                    </Link>
                </div>
            </div>
            <div>
